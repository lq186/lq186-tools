...
import com.lq186.common.api.IUserInfoApi;
import com.lq186.common.consts.Parameter;
import com.lq186.common.springboot.context.UserInfoHolder;
...
public class TokenInterceptor implements HandlerInterceptor {
    ...
    public TokenInterceptor(IUserInfoApi userInfoApi) {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (StringUtils.isNotBlank(token)) {
            UserInfoHolder.setUserInfo(userInfoApi.getByToken(token));
        }
        return true;
    }
}
